...
class AdoptantsTb(models.Model):
    ...
    sex = models.ForeignKey('SexTb', on_delete=models.DO_NOTHING)
    country = models.ForeignKey('CountryTb', on_delete=models.DO_NOTHING)
    status = models.ForeignKey('StatusTb', on_delete=models.DO_NOTHING)
    ...
    adoptant_pob = models.CharField(max_length=255)
...
class AdoptionsTb(models.Model):
    ...
    orphelin = models.ForeignKey('OrphelinsTb', on_delete=models.DO_NOTHING)
    adoptant = models.ForeignKey(AdoptantsTb, on_delete=models.DO_NOTHING)
...
class DonatorsTb(models.Model):
    ...
    donator_pob = models.CharField(max_length=255)
...
class GiftsTb(models.Model):
    ...
    donator = models.ForeignKey(DonatorsTb, on_delete=models.DO_NOTHING)
    status = models.ForeignKey('StatusTb', on_delete=models.DO_NOTHING)
...
class MessagesTb(models.Model):
    ...
    sender = models.ForeignKey('UsersTb', on_delete=models.DO_NOTHING)
    receiver = models.ForeignKey('UsersTb', on_delete=models.DO_NOTHING, related_name='messagestb_receiver_set')
...
class OrphelinsTb(models.Model):
    ...
    orphelinat = models.ForeignKey(OrphelinatsTb, on_delete=models.DO_NOTHING)
    sex = models.ForeignKey('SexTb', on_delete=models.DO_NOTHING)
    country = models.ForeignKey(CountryTb, on_delete=models.DO_NOTHING)
    status = models.ForeignKey('StatusTb', on_delete=models.DO_NOTHING)
...
class UsersTb(models.Model):
    ...
    role = models.ForeignKey(RolesTb, on_delete=models.DO_NOTHING)
    sex = models.ForeignKey(SexTb, on_delete=models.DO_NOTHING)
    country = models.ForeignKey(CountryTb, on_delete=models.DO_NOTHING)
    status = models.ForeignKey(StatusTb, on_delete=models.DO_NOTHING)
    ...
    user_pob = models.CharField(max_length=255)
